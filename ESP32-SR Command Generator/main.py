...
#
#   ComBagde Code:
# python3 main.py "Call Contact,Calling Contact;Record Memo,Record Note;Open Config,Show Config;\
# Close Config,End Config;Open Files,Show Files;Close Files,End Files;Update Contacts,Sync Contacts;\
# Update Wireless,Sync Wireless;Blank Command One;Blank Command Two"
#
#
#   OG code:
